...
Esta forma es una alternativa para validar reglas personalizadas a cualquier objeto independiemente al entity framework, como por ejemplo validaciones que se pueden hacer a un archivo de excel antes de importarlo, puede parecer muchisimo más código pero nos permite validar de forma individual cada regla, lo cual lohace más fácil de probar.

El entity framework de .net ofrece una forma mas sencilla de realizar validaciones personalizadas, esto lo veremos en la siguiente lección
