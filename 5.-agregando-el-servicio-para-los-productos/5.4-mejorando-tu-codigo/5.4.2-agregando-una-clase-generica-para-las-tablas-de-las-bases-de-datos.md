...
Primero vamos a crear una interfaz llamada IAccesoDao el cual contiene los métodos comunes, el cual utiliza generics, en el cual se recibe un objeto como parámetro, este objeto sera el nombre de la clase de la base de datos, por ejemplo Categoria, Producto.
...
Modificamos nuestra clase CategoriaDAO agregando nuestra clase AccesoDAO pasando como parámetro la tabla Categoria, para practicar puedes cambiar el método Modificar y crear las reglas personalizadas para modificar y comparar con mi solución en github
