...
{% hint style="info" %}
Como una mejora, se puede crear una interfaz **IIPServicio** con el método **ObtenesDatosPorIpAsync** para si a futuro se desea cambiar el método para obtener las IP lo deseamos cambiar a alguna de paga o de otra compañía.
{% endhint %}
