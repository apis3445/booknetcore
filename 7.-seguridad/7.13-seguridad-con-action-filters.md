...
* **OnActionExecuted**: El código dentro de esta función se ejecuta después de cada servicio. Mas adelante utilizare este método para guardar el historial de que usuario ha agregado o modificado registros.
...
2. Cambiamos nuestro controller ProductosController, para que herede de nuestra clase creada y agregamos los datos de nuestra objeto permisoDTO, en nuestro constructor agregamos nuestro constructor de la clase base.
