...
{% hint style="info" %}
Se puede considerar el status 404 solo cuando la url del servicio no existe, y en caso de que no existaa el registro, se puede regresar el status 200 con un json vacío.
{% endhint %}
