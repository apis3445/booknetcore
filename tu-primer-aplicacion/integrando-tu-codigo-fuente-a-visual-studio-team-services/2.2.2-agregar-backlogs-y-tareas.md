...
En la opción de Title elegimos el título del backlog a realizar. En este ejemplo la primer tarea es el **Análisis del Sistema** y damos clic en el botón **Add**
