...
1. Utilizar la versión preliminar de _SQL Operations Studio_ [_https://docs.microsoft.com/en-us/sql/sql-operations-studio/download?view=sql-server-2017_](https://docs.microsoft.com/en-us/sql/sql-operations-studio/download?view=sql-server-2017)

![Figura 2.1.2 Configurar SQL Operations Studio](../.gitbook/assets/sql-operations.png)
