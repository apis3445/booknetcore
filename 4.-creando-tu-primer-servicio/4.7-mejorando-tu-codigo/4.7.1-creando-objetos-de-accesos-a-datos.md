...
Crea una nueva carpeta llamada **Core** el cual tendrá clases con funciones genéricas. La calse se llama **CustomError**. Aquí vamos a regresar los mensajes de error de acuerdo al estándar de lo servicios rest el cual incluye el StatusCode, el mensaje y adicionalmente  el nombre del campo del error.
