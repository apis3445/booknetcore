...
1.  Primero desde una terminal agrega la herramienta dotnet ef con el siguiente comando
    ...
    ```
2. Sobre el proyecto  clic derecho del mouse luego **Herramientas -> Abrir en Terminal**

![](<../.gitbook/assets/image (35).png>)

2.Ejecutamos el comando para crear la migración `dotnet ef migrations add CreacionInicial`
