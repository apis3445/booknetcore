...
En nuestro archivo Program.cs que es la clase que inicia los servicios agregamos la llamada a la función Inicializar
...
public static void Main(string[] args)
{
    ...
    var caducaContext = scope.ServiceProvider
